...
IO		=	ft_putchar.c ft_putchar_fd.c ft_putendl.c ft_putendl_fd.c \
			ft_putnbr.c ft_putnbr_fd.c ft_putstr.c ft_putstr_fd.c
STRING	=	ft_str_is_alpha.c ft_str_is_lowercase.c \
			...
			ft_strnequ.c ft_strnew.c ft_strnstr.c ft_strcasestr.c \
			ft_strrchr.c ft_strsplit.c ft_strstr.c ft_strclen.c \
...
LIST	=	ft_lstadd.c ft_lstdel.c ft_lstdelone.c ft_lstiter.c ft_lstmap.c \
			ft_lstnew.c ft_lstrev.c ft_lstlen.c  ft_lstaddbk.c \
			ft_lstlast.c ft_lstat.c ft_strlstsplit.c
CTYPE	=	ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isblank.c \
			ft_iscntrl.c ft_isdigit.c ft_isgraph.c ft_islower.c ft_isprint.c \
